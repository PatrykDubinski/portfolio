    ...
    <div className="about" id="about">
      ...
      <div className="about__right">
        <p>
          ...
          Poland. I've also finished technical school and received IT technicial
          diploma. I've finished a lot of programming courses from FreeCodeCamp
          or other YouTube coders and some from courses websites like:
        </p>
        <ul>
